...
2. Replace **all required inputs** in your workflow with the corresponding **API Input Nodes**.  
3. **Add** an API Output Node and connect it to your final output node to expose the result through the API.

<div style={{display:'flex', justifyContent:'center', marginBottom:'20px'}}>
  <div style={{width:'100%'}}>
    ![](/img/node_introduction/api_nodes/api6.png)
  </div>
</div> 
