...
Use it when:
- The main object is not centered correctly  
- The character is facing the wrong direction  
- The camera angle needs correction  
- You want multiple angle variations via seed changes  
...
- Making stickers or UI icons  
- Feeding a clean silhouette into other Atlas nodes (e.g., Mask-to-Spline)
