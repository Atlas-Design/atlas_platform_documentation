...
- **01. Save project file**: Preserve your current setup, prompts, and generated assets.
...
- **01. ART jobs**:  
  Total number of currently running jobs in ART core

- **02. APS Jobs**:  
  Total number of currently running jobs in Asset Presentation Stage. This is the stage that will be run after ART core to generate an optimized gamed asset with PBR textures. 
---
